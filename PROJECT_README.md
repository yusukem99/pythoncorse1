...
## 4. Colab用リンク集 (生徒共有用)
生徒へ共有する際は、以下の「Colabで開く」URLを共有してください。クリックするだけでColab上に自身の解答用ノートブックが立ち上がり、すぐに演習を開始できます。

**第1章: Arithmetic and Variables (算術演算子と変数)**
- 解説: [Colabで開く](https://colab.research.google.com/github/yusukem99/pythoncorse1/blob/main/notebooks/intro_to_programming/tutorials/arithmetic-and-variables.ipynb)
- 演習: [Colabで開く](https://colab.research.google.com/github/yusukem99/pythoncorse1/blob/main/notebooks/intro_to_programming/exercises/exercise-arithmetic-and-variables.ipynb)

**第2章: Functions (関数)**
- 解説: [Colabで開く](https://colab.research.google.com/github/yusukem99/pythoncorse1/blob/main/notebooks/intro_to_programming/tutorials/functions.ipynb)
- 演習: [Colabで開く](https://colab.research.google.com/github/yusukem99/pythoncorse1/blob/main/notebooks/intro_to_programming/exercises/exercise-functions.ipynb)
